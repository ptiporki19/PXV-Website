...
# Create scripts to fix all service pages
# This master script creates individual update scripts for each service page

# Fix SEO Service Page
cat > fix-seo.sh << 'EOL1'
#!/bin/bash
...
<body>
    ...
    <header>
        <div class="container">
            <div class="logo">
                <a href="index.html"><h1>PrimeX</h1></a>
            </div>
            <nav>
                <ul>
                    <li><a href="index.html">Home</a></li>
                    <li><a href="about.html">About Us</a></li>
                    <li><a href="services.html" class="active">Agency Services</a></li>
    ...
    <section class="service-detail-content" style="background-color: #212529; color: white; padding: 60px 0;">
        <div class="container">
            <!-- Service Overview -->
...
# More scripts would go here for other services

echo "Service update scripts created. Run them individually to update each service page." 